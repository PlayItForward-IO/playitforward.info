...
import { ConfirmationDialogService, ProgressService } from '@playitforward/ngx-shared';
import { UserService, UserState } from '@playitforward/ngx-user';
import { Observable, Subject, debounceTime, distinctUntilChanged, first, takeUntil } from 'rxjs';

@Component({
  selector: 'playitforward-user-profile-update',
