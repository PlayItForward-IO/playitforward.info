...
import { AuthConfig } from '@playitforward/ngx-auth';
import { CachifyConfig } from '@playitforward/ngx-cachify';
import { ApplicationConfig } from '@playitforward/ngx-config';
import { GqlConfig } from '@playitforward/ngx-gql';
import { GTagConfig } from '@playitforward/ngx-gtag';
import { I18nConfig } from '@playitforward/ngx-i18n';
import { LogLevel, LoggerConfig } from '@playitforward/ngx-logger';
import { StoreConfig } from '@playitforward/ngx-store';
import { UserConfig } from '@playitforward/ngx-user';
